...
use XLaravel\Embedding\Driver\Qdrant\QdrantPayloadStore;
...
class QdrantEmbeddingServiceProviderTest extends TestCase
{
    ...
    public function test_it_binds_qdrant_payload_store(): void
    {
        $this->assertInstanceOf(QdrantPayloadStore::class, app(PayloadStore::class));
    }

    public function test_payload_metrics_stay_on_the_core_database_store(): void
    {
        $this->assertInstanceOf(DatabasePayloadStoreMetrics::class, app(PayloadStoreMetrics::class));
    }
